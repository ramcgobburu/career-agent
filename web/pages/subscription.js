...
const STRIPE_PRICE_IDS = {
  weekly: process.env.NEXT_PUBLIC_STRIPE_WEEKLY_PRICE_ID || 'price_1SZeGKLnMLXIe10aVo6f938A',
  monthly: process.env.NEXT_PUBLIC_STRIPE_MONTHLY_PRICE_ID || 'price_1SZeDILnMLXIe10adeEmQKJa',
};
